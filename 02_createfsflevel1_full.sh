...
do
  ...
  VOL=$(fslnvols $x)
  sed "s/{{VOL}}/${VOL}/g;s/{{RUNNR}}/${RUNNR}/g;s/{{TASK}}/${TASK}/g;s/{{SUBJECT}}/${SUBJECT}/g;s/{{WDIR}}/${WDIR_sed}/g" ${WDIR}/design_template_full.fsf > ${WDIR}/DataCAE/$SUBJECT/ses-T1/design_${TASK}${RUNNR}_full.fsf
