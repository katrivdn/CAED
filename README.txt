...
I analyzed the data by first creating onset files for all conditions, regardless of accuracy. In a second analysis, I only looked at accurate trials.

*NOTE: set-linear order files refer to data-analysis file for contrasting activation for set-inclusion that is higher to linear-order arguments.
