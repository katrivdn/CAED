...
do
  ...
  sed "s/{{RUNNR}}/${RUNNR}/g;s/{{TASK}}/${TASK}/g;s/{{SUBJECT}}/${SUBJECT}/g;s/{{WDIR}}/${WDIR_sed}/g" ${WDIR}/design_templateL2_set-linear_full.fsf > ${WDIR}/DataCAE/$SUBJECT/ses-T1/designL2_set-linear_full.fsf
